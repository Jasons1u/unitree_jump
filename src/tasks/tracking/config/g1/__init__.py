...
from .env_cfgs import (
  unitree_g1_ablation_tracking_env_cfg,
  unitree_g1_agility_tracking_env_cfg,
...
register_mjlab_task(
  task_id="Unitree-G1-Tracking-NSE-Pelvis",
...
register_mjlab_task(
  task_id="Unitree-G1-Tracking-Agility",
  env_cfg=unitree_g1_agility_tracking_env_cfg(),
  play_env_cfg=unitree_g1_agility_tracking_env_cfg(play=True),
  rl_cfg=unitree_g1_tracking_ppo_runner_cfg(),
  runner_cls=MotionTrackingOnPolicyRunner,
)
