...
from .env_cfgs import unitree_g1_23dof_agility_tracking_env_cfg, unitree_g1_23dof_flat_tracking_env_cfg
...
register_mjlab_task(
  task_id="Unitree-G1-23Dof-Tracking-Agility",
  env_cfg=unitree_g1_23dof_agility_tracking_env_cfg(),
  play_env_cfg=unitree_g1_23dof_agility_tracking_env_cfg(play=True),
  rl_cfg=unitree_g1_23dof_tracking_ppo_runner_cfg(),
  runner_cls=MotionTrackingOnPolicyRunner,
)
